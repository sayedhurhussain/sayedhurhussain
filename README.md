...
<img align="right" alt="Learning Animation" width="350" src="https://user-images.githubusercontent.com/74038190/229223263-cf2e4b07-2615-4f87-9c38-e37600f8381a.gif">

### 🎯 **Active Projects**
- 🚀 **E-commerce Platform** - Laravel + React + AWS
- 🔗 **API Gateway Service** - Node.js + Microservices
- 📱 **SaaS Dashboard** - Vue.js + Laravel API
- 🤖 **AI Integration** - Python + Machine Learning

### 🌱 **Learning Journey**
- **Frontend:** React.js, Vue.js, TypeScript
- **Backend:** Microservices, GraphQL, Python
